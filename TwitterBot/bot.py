...
async def twitter_bots(db):
    ...
    try:
        ...
        query = '(@nvctranslator OR @eli5translator OR @woketranslate OR @makethismature) is:reply -is:retweet -is:quote -from:nvctranslator -to:nvctranslator -from:eli5translator -to:eli5translator -from:woketranslate -to:woketranslate -from:makethismature -to:makethismature -"use @nvctranslator" -"use @eli5translator" '
