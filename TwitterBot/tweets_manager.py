...
Tweepy_clients = {
    ...
    "@woketranslate": AsyncClient(consumer_key=os.environ['WOKE_CONSUMER_KEY'], consumer_secret=os.environ['WOKE_CONSUMER_SECRET'], access_token=os.environ['WOKE_ACCESS_TOKEN_KEY'], access_token_secret=os.environ['WOKE_ACCESS_TOKEN_SECRET']),
...
Tweepy_auth = {
    ...
    "@woketranslate": tweepy.OAuth1UserHandler(consumer_key=os.environ['WOKE_CONSUMER_KEY'], consumer_secret=os.environ['WOKE_CONSUMER_SECRET'], access_token=os.environ['WOKE_ACCESS_TOKEN_KEY'], access_token_secret=os.environ['WOKE_ACCESS_TOKEN_SECRET']),
...
def get_intro_for_the_tweet(username: str, bot: str):
    ...
    match bot:
        ...
        case "@woketranslate":
            intro = f"With an eye for kindness and understanding, here's @{username}'s message in simpler, thoughtful words."
        case "@makethismature":
